...
# Source code của CustomToken.sol (bao gồm cả mã ERC20)
CONTRACT_SOURCE = """
...
LANG = {
    ...
    'en': {
        ...
        'enter_name': 'Enter token name (VD: Thog Token):',
        'enter_symbol': 'Enter token symbol (VD: THOG):',
...
if __name__ == "__main__":
    asyncio.run(run_deploytoken('vi'))  # Ngôn ngữ mặc định là Tiếng Việt
